				...
				?>
					...
					<tr>
						<td class="label"><label for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo wc_attribute_label( $attribute_name ); ?></label>
						    <input type="text" id="<?php echo "attribute_".$attribute_name  ?>" data-attribute_name="<?php echo "attribute_".$attribute_name  ?>" name="<?php echo "attribute_".$attribute_name  ?>" value="" />
						</td>
					</tr>
